...
class Update extends React.Component {
  ...
  async componentDidMount() {
    ...
    const user = await user_model.getUserByCode({
      user_code: code,
    ...
    if (user.require === false) {
      ...
      if (user_profile_image == "") {
        ...
        this.setState({
          ...
          user_password: user_password,
          user_profile_image: {
            src: GLOBAL.BASE_SERVER.URL + user_profile_image,
            file: null,
  ...
  async _handleSubmit(event) {
    ...
    if (this._checkSubmit()) {
      ...
      if (this.state.user_profile_image.file !== null) {
        ...
        if (res_upload.require) {
          {
            user_profile_image = res_upload.data;
          }
        } else {
          user_profile_image = res_upload.data;
        }
      ...
      const res = await user_model.updateUserBy({
        ...
        user_status: this.state.user_status.trim(),
        license_code: this.state.license_code,
